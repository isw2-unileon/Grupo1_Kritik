              ...
              {topLoading ? (
                ...
                <div className="mt-4 space-y-2">
                  {topRated.map((p) => (
                    ...
                    >
                      {p.Image ? (
                        <img src={p.Image} alt={p.Name} className="h-10 w-10 shrink-0 rounded-xl object-cover ring-1 ring-line" />
                      ) : (
            ...
            {productsLoading ? (
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {allProducts.map((p) => (
                  ...
                  >
                      {p.Image ? (
                        <img src={p.Image} alt={p.Name} className="h-12 w-12 shrink-0 rounded-xl object-cover ring-1 ring-line" />
                      ) : (
